"""
Simple Momentum Strategy: 20% Gain/Loss Rule
...
This is a pure momentum-chasing strategy with binary allocation.
"""
...
class SimpleMomentumStrategy:
    ...
    def load_monthly_data(self):
        ...
        mom_file = self.data_folder / "nifty200_momentum_30_monthly.csv"
        val_file = self.data_folder / "nifty200_value_30_monthly.csv"
    ...
    def run_strategy(self):
        ...
        Rules:
        1. Calculate 3-month momentum return
        2. If momentum gains 20%+ in 3 months → 100% Momentum
        3. If momentum loses 20%+ in 3 months → 100% Value
        4. Otherwise → Stay in current regime
        """
        print("\n" + "="*80)
        print("BACKTESTING: SIMPLE MOMENTUM STRATEGY (20% GAIN/LOSS RULE)")
        print("="*80)
        ...
        # Run SIP analysis
        sip_results, sip_df = self.run_sip_analysis(df, 'Simple Momentum - Nifty 200')
        ...
        # Save results
        output_file = self.output_folder / "portfolio_simple_momentum.csv"
