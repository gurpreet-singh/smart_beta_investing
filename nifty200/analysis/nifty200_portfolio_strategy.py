...
class PortfolioStrategy:
    ...
    def run_strategy(self):
        ...
        This is the optimal strategy with 21.59% CAGR and only 3 switches in 20 years.
        """
        print("\n" + "="*80)
        ...
        # Apply optimized rules: 20% gain / -15% loss
        ...
        # STEP 4 — Calculate portfolio returns with dynamic allocation
        ...
        # Run SIP analysis
        results, sip_data = self.run_sip_on_portfolio(df, 'Simple Momentum (20% Gain/Loss)')
