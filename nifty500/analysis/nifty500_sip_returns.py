"""
Nifty 500 Beta Returns Analysis
Analyzes SIP returns for Nifty500 Momentum 30, Alpha 30, and Value 30 indices
...
class SIPAnalyzer:
    def __init__(self, data_folder, monthly_sip=10000):
        ...
        self.indices = {
            'nifty500mom50': 'NIFTY500 MOMENTUM 50',
            'nifty500val50': 'NIFTY500 VALUE 50'
        }
    ...
    def save_monthly_data(self, monthly_data, index_name):
        ...
        output_dir = self.data_folder.parent / "nifty500" / "output" / "monthly"
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*80)
        print(" "*20 + "NIFTY 500 SMART BETA SIP ANALYSIS")
        print("="*80)
